...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border transition-colors duration-150 hover:bg-muted/30 data-[state=selected]:bg-muted",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("py-3 px-4 align-middle text-sm", className)}
    {...props}
  />
));
